...
void iniciar_programa()
{
    ...
    do
    {
        ...
        {
            case 1:
                cadastrar_aluno(&lista_alunos, arvorebb_curso_raiz);
                break;

            case 2:
                cadastrar_curso(&arvorebb_curso_raiz);
                break;

            case 3:
                cadastrar_disciplina(arvorebb_curso_raiz);
                break;

            case 4:
                cadastrar_matricula(lista_alunos, arvorebb_curso_raiz);
                break;
            ...
            case 7:
                exibir_todos_cursos(arvorebb_curso_raiz);
                break;
            ...
            case 11:
                ...
                if(aluno_buscado != NULL)
                {
                    ...
                    exibir_disciplinas_do_periodo_aluno(aluno_buscado->info.arvbb_nota, semestre);
                }
                else
                    printf("\nAluno não encontrado\n");
                break;
            ...
            case 15:
                ...
                aluno_buscado = lista_alunos_buscar(lista_alunos, matricula);
                if(aluno_buscado != NULL)
                    exibir_historico(aluno_buscado->info, arvorebb_curso_raiz);
                else
                    printf("\nAluno não encontrado\n");
                break;
    ...
    arvorebb_curso_desaloca(&(arvorebb_curso_raiz));
}