...
void lista_desaloca(Lista **lista)
{
    if(*lista != NULL)
    {
        ...
        arvoreavl_desaloca(&((*lista)->info.arvavl_matricula));
        arvoreavl_desaloca(&((*lista)->info.arvavl_nota));
...
//         aluno1.arvavl_matricula = arvoreavl_cria();
//         aluno1.arvavl_nota = arvoreavl_cria();
//         lista_add_ordenado(&lista, aluno1);
//     }
